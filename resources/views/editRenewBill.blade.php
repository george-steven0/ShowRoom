                ...
                <div class="container-fluid">
                    <div class="row bill-header">
                        ...
                        <div class="col-12 text-center main-title font-weight-bold">
                            ...
                            <br>
                            <span>مسلسل رقم</span>
                            <select name="sellbillId" id="renewSellbillId" onchange="renewSellbill()">

                                @foreach ($sellbills as $sellbill )
                                    @if($sellbill->id == $renew->sellbillId )
                                    @continue
                                    @endif
                                    <option value="{{ $sellbill->id }}" selected>{{ $sellbill->id }}</option>
                                @endforeach
                                <option value="{{ $renew->sellbillId }}" selected>{{ $renew->sellbillId }}</option>
                            </select>
                        </div>
