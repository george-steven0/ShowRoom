                ...
                <div class="container-fluid">
                    <div class="row bill-header">
                        ...
                        <div class="col-12 text-center main-title font-weight-bold">
                            ...
                            <br>
                            <span>مسلسل رقم</span>
                            <select name="sellbillId" id="finishbillSellbillId" onchange="finishbillSellbill()">

                                @foreach ($sellbills as $sellbill )
                                    @if($sellbill->id == $finishbill->sellbillId )
                                    @continue
                                    @endif
                                    <option value="{{ $sellbill->id }}" selected>{{ $sellbill->id }}</option>
                                @endforeach
                                <option value="{{ $finishbill->sellbillId }}" selected>{{ $finishbill->sellbillId }}</option>
                            </select>
                        </div>
